...
class others extends CI_Controller {
    ...
    $ndata['login']=$this->session_data;
		...
		$data['others'] = $this->lab_model->get_all_data('others');


    $this->load->view('common/header',$ndata);


    $this->load->view('others/index',$data);
...
public function create()
    ...
    $this->load->view('others/create',$data);
    $this->load->view('common/footer');
	}
  ...
  public function store()
    ...
    $this->load->library('form_validation');
		...
		$this->form_validation->set_rules('title', 'item name othersed', 'required');
		$this->form_validation->set_rules('topic', 'serial number', 'required');
    	$this->form_validation->set_rules('notes', 'serial number', 'required');



    $this->form_validation->set_rules('date', 'condition of the item', 'required');
    ...
    if ($this->form_validation->run() === FALSE)
        ...
        $userRegId=$this->lab_model->insert_data('others', $dataothers);
