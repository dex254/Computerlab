...
class labin extends CI_Controller {
    ...
    $ndata['login']=$this->session_data;
		...
		$data['labin'] = $this->lab_model->get_all_data('labin');


    $this->load->view('common/header',$ndata);


    $this->load->view('labin/index',$data);
...
public function create()
    ...
    $this->load->view('labin/create',$data);
    $this->load->view('common/footer');
	}
  ...
  public function store()
    ...
    $this->load->library('form_validation');
		...
		$this->form_validation->set_rules('name', 'item name labined', 'required');
    ...
    if ($this->form_validation->run() === FALSE)
        ...
        $userRegId=$this->lab_model->insert_data('labin', $datalabin);
