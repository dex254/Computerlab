...
<!-- Mirrored from codervent.com/dashtreme/demo/vertical/errors-500-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 12:22:56 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
	...
	<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&amp;display=swap" rel="stylesheet">
		...
		<title>kipkabus lab error</title>
	</head>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light rounded fixed-top rounded-0 shadow-sm">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">
					<img src="<?php echo base_url("assets/images/5.jpg");?>" width="140" alt="" />
				</a>
					...
					<div class="row g-0">
						<div class="col-xl-5">
							<div class="card-body p-4">
								<h1 class="display-1"><span class="text-white">2</span><span class="text-white">5</span><span class="text-white">4</span></h1>
								<h2 class="font-weight-bold display-4">Sorry, unexpected error</h2>
								<p>Still under development!
									<br>Thi  spart of the systemis still under development by system developer +254708921090 Denis!</p>
								<div class="mt-5">	<a href="http://localhost/lab/index.php/dash" class="btn btn-lg btn-light px-md-5 radius-30">Go Home</a>
									<a href="<?php echo base_url('index.php/login/logout/');?>" class="btn btn-lg btn-white ms-3 px-md-5 radius-30"> login out</a>
								</div>
							</div>
						</div>
						<div class="col-xl-7">
	...
	<div class="switcher-wrapper">
		...
		<div class="switcher-body">
			<div class="d-flex align-items-center">
				<h5 class="mb-0 text-uppercase">lab Customizer</h5>
				<button type="button" class="btn-close ms-auto close-switcher" aria-label="Close"></button>
			</div>
			<hr/>
			<p class="mb-0">Gaussian lab  Texture</p>
			<hr>
			<ul class="switcher">
				<li id="theme1"></li>
				<li id="theme2"></li>
			...
			<hr>
			<p class="mb-0">Gradient  lab Background</p>
			<hr>
			<ul class="switcher">
				<li id="theme7"></li>
				<li id="theme8"></li>
...
<!-- Mirrored from codervent.com/dashtreme/demo/vertical/errors-500-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 12:22:58 GMT -->
</html>
